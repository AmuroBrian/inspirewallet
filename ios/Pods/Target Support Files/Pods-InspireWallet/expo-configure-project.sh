...
with_node \
  ...
  --target "/Users/amurobrian/Documents/reactnativeprojects/InspireWallet/ios/Pods/Target Support Files/Pods-InspireWallet/ExpoModulesProvider.swift" \
  --entitlement "/Users/amurobrian/Documents/reactnativeprojects/InspireWallet/ios/InspireWallet/InspireWallet.entitlements" \
  --platform "apple" \
  --packages "@react-native-google-signin/google-signin" "expo" "expo-asset" "expo-blur" "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-eas-client" "expo-file-system" "expo-font" "expo-keep-awake" "expo-linking" "expo-router" "expo-splash-screen" "expo-system-ui" "expo-updates" "expo-web-browser"
